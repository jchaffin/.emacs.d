...
- [[#configuration][Configuration]]
  ...
  - [[#environment][Environment]]
    ...
    - [[#macos][macOS]]
      - [[#macos-terminal-encoding][MacOS Terminal Encoding]]
  ...
  - [[#programming-tools][Programming Tools]]
    - [[#delimiter-pair-matching][Delimiter Pair Matching]]
      - [[#paredit][Paredit]]
...
This is disabled in the [[https://github.com/syl20bnr/spacemacs/blob/master/layers/%2Bcompletion/ivy/layers.el][spacemacs ivy layer]] with the following
commentblock:
...
I will go to great lengths to avoid using the customization interface.
...
(when (member 'atom-one-dark custom-enabled-themes)
  ...
  (setq highlight-symbol-foreground-color "#E0E0E0"
	highlight-symbol-colors '("#FFEE58" "#C5E1A5" "#80DEEA"
				  "#64B5F6" "#E1BEE7" "#FFCC80")
	highlight-tail-colors '(("#F8BBD0" . 0) ("#FF80AB" . 10)
				("#9575CD" . 30) ("#494949" . 60)
				("#424242" . 80))
	hl-bg-colors '("#DEB542" "#F2804F" "#FF6E64" "#F771AC"
		       "#9EA0E5" "#69B7F0" "#69CABF" "#B4C342")
	hl-fg-colors '("#fdf6e3" "#fdf6e3" "#fdf6e3" "#fdf6e3"
		       "#fdf6e3" "#fdf6e3" "#fdf6e3" "#fdf6e3")
	hl-paren-colors '("#B9F" "#B8D" "#B7B" "#B69"
			  "#B57" "#B45" "#B33" "#B11")
	nrepl-message-colors '("#dc322f" "#cb4b16" "#b58900")))
#+END_SRC
...
(when *is-mac*
  (chaffin-enable-langs 'c-c++ 'common-lisp 'clojure 'groovy 'java
...
#+NAME: c-cxx-config
#+BEGIN_SRC emacs-lisp :tangle yes :noweb yes :exports none
(when (chaffin-enabled-lang-p 'c-c++)
  <<cc-function-args>>
  (when (executable-find "cmake")
    <<cc-irony-mode>>
    <<cc-cmake-mode>>)
  (defun chaffin-c-c++-mode-hook ()
    (smartparens-mode t)
  ...
  (add-to-hooks #'chaffin-c-c++-mode-hook '(c-mode-hook
					    c++-mode-hook)))
#+END_SRC
...
#+NAME: common-lisp
#+BEGIN_SRC emacs-lisp :tangle yes :noweb yes :exports none
(when (chaffin-enabled-lang-p 'common-lisp)
  <<common-lisp-hooks>>
  <<common-lisp-slime>>
)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp :tangle yes :noweb yes :exports none
(when (chaffin-enabled-lang-p 'clojure)
  <<clojure-mode>>
  <<clojure-leiningen>>
  <<clojure-interactive>>)
#+END_SRC
...
#+NAME: java-config
#+BEGIN_SRC emacs-lisp :tangle yes :noweb yes :exports none
(when (chaffin-enabled-lang-p 'java)
...
#+NAME: js-config
#+BEGIN_SRC emacs-lisp :noweb yes :tangle yes
(when (chaffin-enabled-lang-p 'javascript)
  <<js2-mode-config>>
  <<flycheck-js-config>>
  <<npm-mode-config>>
  <<coffee-mode-config>>
...
[[https://github.com/proofit404/company-tern][Company Tern]] provides code completion using tern company backned.
...
#+BEGIN_SRC emacs-lisp :tangle yes :noweb yes :exports none
(when (chaffin-enabled-lang-p 'markdown)
...
#+BEGIN_SRC emacs-lisp :tangle yes :noweb yes :exports none
(when (chaffin-enabled-lang-p 'ruby)
  <<ruby-mode-config>>
  <<rvm-config>>)
#+END_SRC
...
#+NAME: scala-config
#+BEGIN_SRC emacs-lisp :tangle yes :noweb yes :exports none
(when (chaffin-enabled-lang-p 'scala)
  <<scala-mode-config>>
...
#+BEGIN_SRC emacs-lisp :noweb yes :tangle yes
(when (chaffin-enabled-lang-p 'web)
