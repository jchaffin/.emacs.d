...
(defun chaffin--org-mode-vfc-hook ()
  (setq-local visual-fill-column-use-visual-line t)
  (visual-fill-column-mode 1))
...
(use-package olivetti
  ...
  (progn
    ...
    (add-hook 'olivetti-mode-hook 'centerd-cursor-mode)))
