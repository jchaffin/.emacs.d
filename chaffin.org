...
Fix problem with [[file:/usr/local/Cellar/emacs-plus/HEAD-35e9dca/share/emacs/27.0.50/lisp/saveplace.el.gz::;;;%20saveplace.el%20---%20automatically%20save%20place%20in%20files][saveplace.el]] which puts point back in a folded position.
...
(use-package org-ref
  ...
  (org-ref-default-bibliography (list (dropbox-dir "org" "ref" "references.bib")))
  (org-ref-bibliography-notes  (dropbox-dir "org" "ref" "refnotes.org"))
  (org-ref-pdf-directory  (dropbox-dir "org" "papers" "pdfs"))
  ...
  :config
  ;; (setq reftex-default-bibliography (list (dropbox-dir "org" "ref" "references.bib")))
