...
#+NAME: copy-prefix-map
#+BEGIN_SRC emacs-lisp :tangle yes
(define-prefix-command 'copy-prefix-map)
(define-key 'chaffin-keymap "c" 'copy-prefix-map)
#+END_SRC
...
(define-key 'copy-prefix-map "f" 'copy-file-path-as-kill)
#+END_SRC
...
(use-package ivy
  ...
  ;; [2] https://github.com/raxod502/radian/blob/develop/radian-emacs/radian-coxompletion.el#L25
...
(use-package web-mode
  ...
  (add-hook 'web-mode-hook #'halidom/webmode-style)
