...
#+OPTIONS: H:5 num:t toc:t \n:nil d:nil tasks:nil tags:nil tex:t num:nil todo:nil
...
#+NAME: macos-config
#+BEGIN_SRC emacs-lisp :noweb yes :tangle yes :results output
  (when *is-mac*
     (progn
...
(add-to-list 'org-file-apps '("pdf" . auto-mode))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp :tangle yes :noweb yes :results output
  (use-package company
    :ensure t
    :defer t
