...
#+BEGIN_SRC emacs-lisp :tangle yes
(defun straight-browse-at-github (&optional package)
  (interactive "P")
...
(defvar uname
  ...
  "Print the operating system name using the `uname' UNIX command.")

(defconst *is-mac* (or (eq system-type 'darwin) (string= "darwin" uname)))
(defconst *is-linux* (or (eq system-type 'gnu/linux) (string= "linux" uname)))
