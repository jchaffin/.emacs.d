...
(add-hook 'after-init-hook 'modeline-setup)
...
(use-package mode-icons
  ...
  :if (display-graphic-p)
  :init
  (add-hook 'sml-setup-hook #'mode-icons-mode))
#+END_SRC
...
#+NAME: theme-spec
#+BEGIN_SRC emacs-lisp :tangle yes :noweb yes
(defcustom halidom-default-theme-mode 'dark
...
(defcustom halidom-default-term-theme 'wombat
  "The default term theme."
  :type 'symbol)

(defcustom halidom-default-light-theme 'tsdh-light
  "The default light theme."
  :type 'symbol)

(defcustom halidom-default-dark-theme 'tsdh-dark
  "The default dark theme."
  :type 'symbol)

(defcustom halidom-default-theme 'tsdh-dark
...
(use-package poet-theme
  :straight t
  :init
  (setq halidom-default-light-theme 'poet))
#+END_SRC
...
(use-package base16-theme
  :straight t
  :init
  (setq halidom-default-dark-theme 'base16-oceanicnext)
  :config
...
#+BEGIN_SRC emacs-lisp :tangle yes
(setq-default custom-enabled-themes (list halidom-default-theme))
...
(defun halidom/load-theme ()
  ...
  (if (display-graphic-p)
      (progn
        (load-theme halidom-default-theme)
        (run-hooks 'halidom/load-theme-hook))

    (progn
      (load-theme halidom-term-theme))))

(setq halidom-default-theme
      (cond ((eq halidom-default-theme-mode 'dark)
             halidom-default-dark-theme)
            ((eq halidom-default-theme-mode 'light)
             halidom-default-light-theme)
            (t nil)))

(defun halidom/org-faces (&optional theme)
  (custom-theme-set-faces (or theme halidom-default-theme)
    `(org-block
    ...
    `(org-block-begin-line
      ((t (:background "#35373E"
           :foreground "#ABB2BF"
           :inherit (org-meta-line default)))))
    `(org-end-of-line ((t (:inherit org-block-begin-line))))
    `(org-document-title
    ...
    `(org-document-info-keyword
      ((t (:foreground "#ABB2BF" :slant italic :inherit org-document-info-face))))
    `(font-lock-keyword-face
      ((t (:foreground "#C678DD" :slant italic :weight normal)))))
)


(defun halidom-theme-load-update-buffer ()
  (auto-revert-mode)
...
(add-hook 'halidom/load-theme-hook #'halidom-theme-load-update-buffer)
...
(use-package company-emoji
  ...
  (add-hook 'org-mode-hook 'company-emoji-setup)
...
#+NAME: company-config
#+BEGIN_SRC ess-noweb :language emacs :tangle yes :noweb yes :exports none
<<company-company>>
<<company-quick-help>>
