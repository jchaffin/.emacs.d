      ...
      (ivy-read
       ...
       :action (lambda (package)
                 (let ((default-directory
                         (concat (file-name-as-directory repo-dir) package)))
...
(use-package visual-fill-column
  ...
  (progn
    ...
    ;; https://github.com/hlissner/doom-emacs/blob/master/core/core-ui.el#L326-L331
    (setq-default visual-fill-column-center-text t
                  visual-fill-column-width
                  (+ (fboundp 'display-line-numbers) 6 0) fill-column)

    (add-hook 'visual-fill-column-hook 'visual-line-mode)))
#+END_SRC
