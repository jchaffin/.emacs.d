...
notebook, personal journal, and StackOverflow pasteboard.
...
(setq org-export-filter-headline-functions '(headline-numbering-filter section-title-filter))
#+END_SRC
...
[fn:12] [[https://www.gnu.org/software/emacs/manual/html_node/elisp/Library-Headers.html#Library-Headers][Emacs Manual - D.8 Conventional Headers for Emacs Libraries]]
