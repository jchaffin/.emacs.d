...
(defun halidom/font-setup (&optional frame)
  (cond
    (*is-linux*   
     (set-frame-font "Ubuntu Mono 12" frame t))
    (*is-windows*
     (set-frame-font "Lucida Sans Typewriter 12" frame t))
    (*is-mac*
     (set-frame-font macos-default-font frame t))
    (t
     (set-frame-font "Menlo 12" frame t))))
