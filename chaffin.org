...
- [[#latex-and-org-mode][LaTeX and Org Mode]]
  ...
  - [[#org-mode][Org Mode]]
    ...
    - [[#document-management][Document Management]]
      ...
      - [[#org-links][Org Links]]
    - [[#agenda-and-calendar][Agenda and Calendar]]
  ...
  - [[#org-latex][Org LaTeX]]
    ...
    - [[#org-ref][Org Ref]]
      - [[#support-vref-links][Support =vref= links]]
      - [[#open-pdf-at-point][Open Pdf at point]]
    - [[#org-pdf][Org PDF]]
  - [[#org-mode-export][Org Mode Export]]
    - [[#enable-backends][Enable Backends]]
    - [[#ox-latex][Ox LaTeX]]
      - [[#set-latex-pdf-process][Set latex pdf process]]
      - [[#prefer-user-provided-labeling-system][Prefer user provided labeling system]]
      - [[#org-latex-default-packages][Org LaTeX Default Packages]]
      - [[#hyperref-template][Hyperref Template]]
      - [[#custom-latex-classes][Custom LaTeX Classes]]
      - [[#filter-section-numbering-by-tag][Filter Section Numbering by tag]]
    - [[#ox-bibtex][Ox Bibtex]]
    - [[#ox-pandoc][Ox Pandoc]]
    - [[#ox-gfm][Ox GFM]]
    - [[#ox-hugo][Ox Hugo]]
...
#+NAME: org-agendacal
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :exports none
<<org-agendacal-agenda>>
<<org-agendacal-projectile>>
<<org-agendacal-pomodoro>>
<<org-agendacal-gcal>>
#+END_SRC

**** Org Agenda

#+NAME: org-agendacal-agenda
#+BEGIN_SRC emacs-lisp :tangle no :noweb yes :exports none
<<org-agenda-diary>>
...
Tools for checking lexical and grammatical errors in text buffers[fn:13].
...
#+NAME: completion-osx-dictionary
#+BEGIN_SRC emacs-lisp :tangle no
...
Tabs are the bane of humanity[fn:14]. [[http://www.urbandictionary.com/define.php?term=dont%20%40%20me][Don't @ me]].
...
[fn:12] [[http://fgiasson.com/blog/index.php/2016/06/14/my-optimal-gnu-emacs-settings-for-developing-clojure-revised/][fgiasson.com - My Optimal Gnu Emacs Settings for Developing
Clojure Revised]]

[fn:13] https://joelkuiper.eu/spellcheck_emacs

[fn:14] [[https://www.emacswiki.org/emacs/TabsAreEvil][Emacs Wiki - Tabs Are Evil]]
