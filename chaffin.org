...
(general-define-key
 :keymaps 'halidom-prefix-map
 :prefix-command 'macos-prefix-command
 :prefix-map 'macos-prefix-map
 :prefix "m"
 )
#+END_SRC
...
(general-define-key
 :keymaps 'halidom-prefix-map
 :prefix "p"
 :prefix-command 'prose-prefix-command
 :prefix-map 'prose-keymap)
