...
- [[#configuration][Configuration]]
  ...
  - [[#org-mode][Org Mode]]
    ...
    - [[#org-utilities][Org Utilities]]
      ...
      - [[#org-hyperlinksfn15][Org Hyperlinks[fn:15]]]
    - [[#org-pdf][Org PDF]]
      - [[#pdf-tools][PDF Tools]]
  ...
  - [[#web-browsing][Web Browsing]]
    ...
    - [[#when-no-external-web-browser-is-availablefn12][When no external web browser is available[fn:12]]]
      - [[#set-the-default-browser-ewwfn14][Set the default browser =eww=[fn:14]]]
...
#+RESULTS: org-utils-pomodoro-org-pomodoro
: org-pomodoro
...
**** Set the default browser =eww=[fn:14]
...
#+BEGIN_SRC emacs-lisp :tangle no
(defun chaffin-compile-hook (command)
  (unless (file-exists-p "makefile")
    (set (make-local-variable 'compile-command)
         (let ((file (file-name-sans-extension buffer-file-name)))
           (format "%s %s -o %s" command buffer-file-name file)))))
...
[fn:12] e.g when I'm not allowed to run a =vnc-server=[fn:13]

[fn:13] e.g. when I'm on the =lnxsrv.seas.ucla.edu=

[fn:14] [[https://emacs.stackexchange.com/a/7332][Stack Exchange - How to make eww default browser in emacs]]

[fn:15] [[https://www.gnu.org/software/emacs/manual/html_node/org/Adding-hyperlink-types.html][Adding Hyperlink types]]
