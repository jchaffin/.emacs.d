...
#+BEGIN_SRC emacs-lisp
  (use-package ivy-todo
    ...
    (when (bound-and-true-p dotemacs-default-agenda-file)
      (setq-default ivy-todo-file dotemacs/org-agenda-global-agenda-file)))
#+END_SRC
  ...
  (use-package org-gcal
    ...
    (org-gcal-file-alist
     `(("jchaffin@g.ucla.edu" . ,gcal-agenda-file)
       ("t2iba0hggoc8c8u0h85667dkj0@group.calendar.google.com" . "~/Dropbox/Documents/2020/fall/cs181/schedule.org")))
    :config
    (require 'org-agenda)
