...
(use-package macos-dev-utils
  ...
  (which-key-add-key-based-replacements
    "M-m t i" " iTerm"
    "M-m t i g" " File or Directory"
    "M-m t i f" " Bring to Front"
...
(use-package sh-script
  ...
  (sh-indentation 2)
  :init
  (defun sh-script-mode/disable-org-link ()
    (org-link-minor-mode -1))
  :hook
  (sh-script-mode  . sh-script-mode/disable-org-link))
...
#+BEGIN_SRC emacs-lisp
  (use-package ace-window
    ...
    :hook
    (ace-window-display-mode . aw-set-face))
...
(use-package org-ref
  :straight (org-ref :type git
                     ...
                     :fork (:host github :repo "jchaffin/org-ref"))
  :after ivy
  :custom
