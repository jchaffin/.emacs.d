...
(use-package dired
  ...
  (defun dired-do-open-with (&optional arg)
    ...
    refactor    (mapcar #'dired-open-with file-list))))
...
(use-package popwin
  ...
  :bind-keymap* ("C-c C-z" . popwin:keymap)
...
[[elisp-variable:org-bullets:org-bullets-bullet-list][org-bullets-bullet-list]] variable.
...
** Version Control
[[info:emacs#Version%20Control][Version Control]] is the built-in version control system for Emacs.
...
*** Company slime
:PROPERTIES:
:ID:       6EE87F7B-2275-4874-83F9-96833C4E8DA1
:END:
