...
(use-package macos-dev-utils
  ...
  (("M-m o" . macos-open-with-command-map)
   ("M-m t i" . macos-iterm-command-map))
  :config
  (which-key-add-key-based-replacements
    "M-m t i" " iTerm"
    "M-m t i g" "open at cwd"
    "M-m t i f" " window to front"
    "M-m t i s" " shell command"
    "M-m o" " Open With"
    "M-m o o" " Default"
    "M-m o s" " ST3"
    "M-m o a" " Atom"
...
#+BEGIN_SRC emacs-lisp
  (use-package ace-window
    ...
    (aw-leading-char-face
     ((t (:inverse-video t :inherit avy-lead-face :height 3.0))))
    :bind
    ("M-o" . ace-window)
    :custom
    ...
    (aw-background nil)
    :init
    (when (custom-facep 'aw-leading-char-face)
...
(use-package emms
  ...
  ;; add flv and ogv
  (define-emms-sim ple-player mplayer '(file url)
...
(use-package org-capture
  ...
  (with-eval-after-load ' org-capture
    ...
    (defadvice org-capture (before org-capture-before activate)
      (remove-hook 'org-mode-hook 'org-pretty-tags-mode))

    (defun org-capture-restore-tag-overlays ()
    ...
    (setq org-capture-templates
          `(("l" "Protocol Link" entry
            ...
            ("j" "Journal" entry (file+olp+datetree "~/Dropbox/org/journal.org")
             "* %?\nEntered on %U\n  %i\n  %a")
            ("c" "Contact" entry (file+headline "contacts.org")
             ,org-contacts-template
             :empty-lines 1))))
  :hook
  (org-capture-after-finalize . org-capture-restore-tag-overlays))
#+END_SRC
...
(remove-hook 'org-mode-hook 'org-mode-save-place-fix)
#+END_SRC
