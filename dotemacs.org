...
#+BEGIN_SRC emacs-lisp
  ...
  Optional argument ARG Does nothing."
    ...
    (org-ref-link-set-parameters "vref"
      ...
      :complete #'org-ref-vref-complete-link
...
(use-package ox-pandoc
  ...
  (defun org-pandoc-pdf-engine-set (&optional process)
    ...
    (let* ((process
            (or process
                (assoc
                 (completing-read "Pandoc Process: " dotemacs-latex-pdf-engines nil nil)
                 dotemacs-latex-pdf-engines)))
  ...
  (use-package org-variable-pitch
    ...
    (variable-pitch
     ((((type w32))
      ...
      (t (:family "Fira Sans"))))
    :custom
    (org-variable-pitch-face "Fira Sans")
