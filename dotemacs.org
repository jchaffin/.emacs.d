...
(use-package ivy-bibtex
  ...
  :demand t
  :preface
  (set-fontset-font "fontset-default" '#xE415 "Material Icons")
  :bind
  ("C-x c" . ivy-bibtex)
  :custom
...
(use-package engine-mode
  ...
  :preface
  (set-fontset-font "fontset-default" '#xE80C "Material Icons")
  (set-fontset-font "fontset-default" '#xE3F4 "Material Icons")
  :bind*
  (:map web-prefix-map
