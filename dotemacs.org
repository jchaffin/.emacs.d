...
(defun org-preview-set (engine class)
  (let* ((process-alist (intern (concat (symbol-name engine) "-preview-process-alist")))
	       (class (symbol-name (org-preview/process-class)))
    ...
    (if (member (symbol-name engine) org-latex-compilers)
	      (set (make-local-variable 'org-preview-latex-process-alist) (symbol-value process-alist))
	    (error "%s is not in `org-latex-compilers'" (symbol-name engine)))
...
(use-package org-agenda
  ...
  :demand t
  :preface
  (set-fontset-font "fontset-default" '#xE876 "Material Icons")
...
(use-package org-pretty-tags
  ...
  :preface
  (set-fontset-font "fontset-default" '#xE917  "file-icons")
  ...
  (set-fontset-font "fontset-default" '#xE5D2 "Material Icons")
  (set-fontset-font "fontset-default" '#xE051 "Material Icons")
  :custom
