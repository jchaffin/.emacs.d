...
(with-eval-after-load 'org-mode
  (when (fboundp 'no-littering-expand-etc-file-name)
...
(use-package pretty-fonts
  ...
  :preface
  (defcustom font/family-overrides-alist
    '(("github-octicons"
       ;;                           
       61585 61529 61558 61557 61462 61553 61636)
      ("all-the-icons"
       ;;            
       59682 59687 59688 69655)
      ("file-icons"
       ;;                      
        58880  58881  59686  59671  59674)
      ("Material Icons"
       ;;                   
       #xE80C #xE8CE 57425 57439 57425
       ;;                  
       58320  58321  58322 58324 58343
       ;;                  
       58356  58389  58819 58842 59404
       ;;              𐿮
       59505  59510  59672 69614)
      ("Weather Icons"
       ;; 
       61559)
      ("Apple Color Emoji"
      ...
      ;; 🎓   🗣      💻    📎      🌍
       127891 128483 128187 128206 #x1F30D
      ;; ❌   🚫     🔗    🛒    🔈
  ...
  (defun pretty-fonts-after-theme ()
    ...
    (let ((fontsets (--filter (font-utils-exists-p (car it)) font/family-overrides-alist)))
...
(use-package engine-mode
  ...
  (setq engine-mode-wk-replacement-alist
    '(( "M-m b"        "🌍 Browse")
      ( "M-m b e"      "🔎 Web Engine")
      ( "M-m b e y"    " Youtube")
      ( "M-m b e p"    " Proquest")
...
(use-package hideshowvis
  :init
  (when (symbolp 'dotemacs-theme-colors)
