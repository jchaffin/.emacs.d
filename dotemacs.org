...
#+BEGIN_SRC emacs-lisp
(defcustom dotemacs-bibliography-file (expand-file-name "ref/references.bib" org-directory)
...
(defcustom dotemacs-pdf-directory
  (seq-filter #'file-directory-p (directory-files-no-wildcards
                                  "~/Dropbox/Documents/pdfs" t))
...
;; TODO keywords
  ...
  (defvar dotemacs/default-agenda-file "~/Dropbox/org/agenda/TODOs.org"
