...
(use-package latex-unicode-math-mode
    :init
  (defun latex-math-enable-unicode ()
    (latex-unicode-math-mode t)
    (setq LaTeX-math-menu-unicode t))
    :hook
    (LaTeX-mode . latex-math-enable-unicode))
#+END_SRC
...
(use-package skeletor
    ...
    (defun skeletor-add-pyenv-pythons ()
      ...
      (if-let* ((pyenv-dir (getenv "PYENV_ROOT"))
...
(use-package all-the-icons
  ...
  (let ((dest-dir
    ...
    (unless (file-exists-p (resolve-path dest-dir "all-the-icons.ttf"))
