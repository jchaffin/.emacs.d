...
(use-package org-agenda
  ...
  (setq org-agenda-category-icon-alist
   `(("syntax" ,(list "Ᾱ")  nil nil :ascent center)
     ...
     ("algorithms" ,(list "") nil nil :ascent center)
...
#+BEGIN_SRC emacs-lisp :tangle no
  (when (or *is-mac* (string= system-name "archer"))
...
(use-package skeletor
    ...
    (defun skeletor-add-pyenv-pythons ()
      ...
      (let* ((pyenv-dir (or (getenv "PYENV_ROOT") (user-home ".pyenv")))
...
(defun halidom/load-theme (&optional theme)
  ...
  (let* ((options (mapcar 'symbol-name (custom-available-themes)))
         (theme-name (if (interactive-p)
                     ...
                     (eval (intern (concat "halidom-" (format "%s" (symbol-value 'halidom--theme-style)) "-theme")))))
...
(defun halidom/load-default-theme ()
    (interactive)
  (halidom/load-theme))
