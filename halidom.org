...
#+NAME: pretty/outshine
#+BEGIN_SRC emacs-lisp :tangle no
(use-package outshine
  :init (require 'outshine)
  :hook
  (outshine-minor-mode . outshine-hook-function)
  ((message-mode clojure-mode LaTeX-mode emacs-lisp-mode) . outline-minor-mode))
#+END_SRC
...
#+NAME: ekaschalk/recipe
#+BEGIN_SRC emacs-lisp :tangle no
(use-package pretty-macros
  :straight (pretty-macros
             :repo "ekaschalk/.spacemacs.d"
             :host github
             :type git
             :files ("layers/macros/local/macros/macros.el"))
  :init
  (require 'macros))
...
#+NAME: ekaschalk/fonts
#+BEGIN_SRC emacs-lisp :tangle no
  (use-package pretty-fonts
    :straight (pretty-fonts
               :repo "ekaschalk/.spacemacs.d"
               :host github
               :type git
               :files ("layers/display/local/pretty-fonts/pretty-fonts.el"))
...
#+BEGIN_SRC emacs-lisp :tangle no
  (use-package pretty-outlines
    ...
    :hook
    ((emacs-lisp hy-mode python-mode)
     . pretty-outlines-add-bullets)
    ((outline-mode outline-minor-mode)
     . pretty-outlines-set-display-table))
...
(use-package outline-ivy
  ...
  (outline-ivy
     ...
     :host github
     :type git
     :files ("layers/personal/local/outline-ivy/outline-ivy.el"))
  :init
...
(use-package pretty-eshell
  :straight (pretty-eshell
             ...
             :host github
             :type git
             :files ("layers/display/local/pretty-eshell/pretty-eshell.el"))
  :custom-face
...
#+NAME: ekaschalk/magit
#+BEGIN_SRC emacs-lisp :tangle no
  (use-package pretty-magit
    :straight (pretty-magit
               :repo "ekaschalk/.spacemacs.d"
               :host github
               :type git
               :files ("layers/display/local/pretty-magit/pretty-magit.el"))
    :after (:all magit ivy)
    :config
...
(use-package pretty-code
  :straight (pretty-code
             :repo "ekaschalk/.spacemacs.d"
             :host github
             :type git
             :files ("layers/display/local/pretty-code/pretty-code.el"))
...
(use-package dune
    ...
    :init
    (when (functionp 'projectile-register-project-type)
