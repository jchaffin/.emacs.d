...
(use-package macos-dev-utils
  ...
  (which-key-add-prefix-title "M-m m t" "")
  (which-key-add-prefix-title "M-m m o" ""))
...
#+BEGIN_SRC emacs-lisp :tangle no
  ...
  (which-key-add-prefix-title "M-m o" "")
#+END_SRC
 
...
(use-package projectile
  ...
  (which-key-add-prefix-title "C-c p" "")
