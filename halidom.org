...
#+BEGIN_SRC emacs-lisp :tangle no
  (use-package org-sidebar
    ...
    (with-eval-after-load 'org-sidebar
      (org-sidebar-defsidebar sidebar/syntax
        :header "Syntax"
...
**** Org Modules
:PROPERTIES:
:ID:       7197831D-BE24-417E-A84B-9A36C1466145
:END:
...
#+BEGIN_SRC emacs-lisp :tangle no
  (with-eval-after-load "esh-opt"
    ...
    (setq eshell-prompt-regexp "λ\\s-")   ; or "└─> "
