  ...
  (use-package org-projectile
    ...
    (progn
      ...
      (defun org-projectile-files-to-agenda ()
	      ...
	      (interactive)
	      (let* ((todo-filepath (or (bound-and-true-p org-projectile-per-project-filepath)
		                              "org/TODOs.org"))
	             (active-projects (seq-filter
                                 (lambda (proj)
			                             (file-exists-p (expand-file-name todo-filepath proj)))
                                 projectile-known-projects))
	             (project-agenda-files (mapcar
                                      (lambda (proj)
