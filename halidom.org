...
(which-key-add-key-based-replacements "M-m s" " Straight")
...
(use-package reveal-in-osx-finder
  ...
  :init
  (define-key 'macos-prefix-map "f"
    '(" Finder" . reveal-in-osx-finder)))
#+END_SRC
...
(use-package counsel-itunes
  ...
  (which-key-add-key-based-replacements "M-m m i" " iTunes"))
