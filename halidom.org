...
- [[#latex-and-org-mode][LaTeX and Org Mode]]
  ...
  - [[#org-mode-export][Org Mode Export]]
    ...
    - [[#company-reftex-1][Company Reftex]]
    - [[#cdlatex-1][cdlatex]]
    - [[#magic-latex-buffer-1][Magic Latex Buffer]]
    - [[#auctex-latexmk-1][Auctex Latexmk]]
    - [[#texinfo-1][Texinfo]]
    - [[#latex-math-1][LaTeX Math]]
  - [[#org-mode-1][Org Mode]]
    - [[#org-babel-1][Org Babel]]
    - [[#org-mode-ui-1][Org Mode UI]]
    - [[#document-management-1][Document Management]]
    - [[#task-management-1][Task Management]]
    - [[#idea-management-1][Idea Management]]
    - [[#org-hacks-1][Org Hacks]]
  - [[#org-latex][Org LaTeX]]
    - [[#latex-in-org-buffers-1][LaTeX in Org Buffers]]
    - [[#edit-latex-1][Edit Latex]]
    - [[#highlight-inline-latex-fragments-1][Highlight inline LaTeX fragments]]
    - [[#org-ref-1][Org Ref]]
    - [[#org-pdf-1][Org PDF]]
    - [[#miscellany][Miscellany]]
  - [[#org-mode-export-1][Org Mode Export]]
    - [[#enable-backends-1][Enable Backends]]
    - [[#ox-org-1][Ox Org]]
    - [[#ox-latex-1][Ox LaTeX]]
    - [[#ox-bibtex-1][Ox Bibtex]]
    - [[#ox-pandoc-1][Ox Pandoc]]
    - [[#ox-gfm-1][Ox GFM]]
    - [[#ox-hugo-1][Ox Hugo]]
    - [[#ox-html-1][Ox HTML]]
    - [[#ox-linguistics-1][OX Linguistics]]
    - [[#ox-extra-1][Ox Extra]]
    - [[#ox-publish-1][Ox Publish]]
...
(setq xelatex-preview-header
      (concat xelatex-preview-header
      "\\usepackage{amsmath}
...
#+BEGIN_SRC emacs-lisp :tangle no
(defcustom lualatex-preview-header org-format-latex-header
  ...
  (set (make-local-variable 'org-format-latex-header)
       (if (org-preview/uclacs-p)
           (concat lualatex-preview-header
                   (read-file-contents
                    (emacs-etc-dir "preview" "uclacs-preview.tex")))
...
#+BEGIN_SRC emacs-lisp :tangle no
(defun org-preview-process-hook ()
  (interactive)
  (let ((latex-compiler (org-preview/process-compiler)))
    (set (make-local-variable 'org-format-latex-options)
        '(:foreground ,(face-attribute 'font-lock-builtin-face :foreground)
          :background default :scale 1.2 :html-foreground "Black"
...
(add-hook 'org-mode-hook 'org-preview-process-hook)
#+END_SRC
...
#+NAME: org-ui-outline-numberiing
#+BEGIN_SRC emacs-lisp :tangle no
...
(use-package org-agenda
  ...
  (define-key goto-map "o" #'goto-org-dir)
  ...
  :config
  (defvar default-agenda-file (resolve-path org-directory "TODOS.org"))

  (defun halidom/default-agenda ()
    (interactive)
    (setq org-agenda-files
          (if (file-exists-p default-agenda-file)
             (list default-agenda-file))))

  (halidom/default-agenda)
  :hook
...
#+BEGIN_SRC emacs-lisp :tangle no
(setq org-highlight-latex-a-related nil)
#+END_SRC
...
(use-package pdf-tools
  ...
  :init
  (defun pdf-view/disable-line-numbers ()
    (when (featurep 'display-line-numbers)
  ...
  :hook
  (pdf-view-mode . pdf-view/disable-line-numbers))
#+END_SRC
...
**** Improve special block options
#+NAME: org-export-latex-special
#+BEGIN_SRC emacs-lisp :tangle no
(with-eval-after-load 'ox-latex
  (el-patch-defun org-latex-special-block (special-block contents info)
  ...
  holding contextual information."
    ...
    (caption-above-p (org-latex--caption-above-p special-block info)))
      (concat  (format  "\\begin{%s}%s\n" type (or opt ""))
        ...
        (el-patch-add
          (and (org-export-read-attribute :attr_latex special-block :center)
             "\\centering\n"))
        contents
        (and (not caption-above-p) caption)
        (format "\\end{%s}" type)
        (el-patch-add (if (string= type "subfigure") "\n~"))))))
...
#+NAME: org-export-latex-subfigures
#+BEGIN_SRC emacs-lisp :tangle no
(use-package ox-latex-subfigure
    :straight (ox-latex-subfigure
               :type git
               :host github
...
#+NAME: devops/docker
#+BEGIN_SRC emacs-lisp :tangle no :noweb strip-export
;; Docker
<<docker-cmds>>
;; Dockerfile Mode
<<docker-dockerfile>>
