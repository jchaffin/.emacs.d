...
(use-package reveal-in-osx-finder
  ...
  :init
  (define-key 'macos-prefix-map (kbd "f") '("" . reveal-in-osx-finder)))
#+END_SRC
...
;; This remaps the atom icon from 'all the icons'
...
(use-package org-sidebar
  ...
  (cl-defmacro course-sidebar (name description &optional extra)
    `(progn
       (org-sidebar-defsidebar ,(intern (concat name "/sidebar"))
                               :header ,description
...
(which-key-add-key-based-replacements "M-m w" '("" .  "Web Browsing"))
