(custom-set-variables
 ...
 '(cdlatex-insert-auto-labels-in-env-templates t t)
 ...
 '(latex/no-fill-environments
   '("align" "align*" "forest" "forest*" "equation" "equation*" "exe" "tabular" "tikzpicture") t)
 '(livedown-open nil t)
 ...
 '(visual-fill-column-width 86 t)
 '(wakatime-cli-path "/usr/local/lib/python3.7/site-packages/wakatime/cli.py")
 '(wakatime-python-bin "/usr/local/Cellar/python/3.7.2/bin/python3")
...
(custom-set-faces
 ...
 '(spaceline-all-the-icons-info-face ((t (:foreground "#63B2FF" :family "Fira Mono for Powerline")))))
