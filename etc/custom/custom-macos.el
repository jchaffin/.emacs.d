(custom-set-variables
 ...
 '(safe-local-variable-values
   '((tramp-remote-path quote
                        ("/usr/local/cs/bin" "/usr/lib64/qt-3.3/bin" "/u/eng/class/classbin/perl5/bin" "/usr/local/bin" "/usr/bin" "/usr/X11R6/bin" "u/eng/class/classbin/bin"))
 ...
 '(tramp-auto-save-directory "/Users/jacobchaffin/.emacs.d/var/tramp/auto-save/")
 '(tramp-default-host "wifi-131-179-20-228.host.ucla.edu")
 '(tramp-default-host-alist '(("adb" nil "")))
 '(tramp-default-method "ssh")
 '(tramp-default-user-alist
   '(("\\`smb\\'" nil nil)
     ("\\`\\(?:fcp\\|krlogin\\|nc\\|r\\(?:cp\\|emcp\\|sh\\)\\|telnet\\)\\'" nil "jacobchaffin")
     ("\\`\\(?:doas\\|ksu\\|su\\(?:do\\)?\\)\\'" nil "root")))
 '(tramp-local-host-regexp
   "\\`\\(127\\.0\\.0\\.1\\|::1\\|localhost6?\\|wifi-131-179-20-228\\.host\\.ucla\\.edu\\)\\'")
