(custom-set-variables
 ...
 '(safe-local-variable-values
   '((org-ref-pdf-directory . "~/Dropbox/Documents/wave/papers/")
     ...
     (projectile-project-compilation-cmd . "ninja clang-tools")
     (projectile-project-compilation-dir . "/usr/local/src/llvm-project/build")
     (projectile-project-run-cmd . "bin/wacvis")
